                ...
                <div className="dashboard">
                    ...
                    <div className="row-2">
                        <div className="panel item-4">
                            ...
                            <div className="panel-body">
                                <div className="item">
                                    <p>{dataSummary && dataSummary.purchases ? dataSummary.purchases.totalPurchases : ""} compras registradas</p>
                                </div>
                                <div className="item">
                                    <h4>Último mes</h4>
                                    <p>
                        ...
                        <div className="panel item-5">
                            ...
                            <div className="panel-body">
                                <div className="item">
                                    <p>{dataSummary && dataSummary.sales ? dataSummary.sales.totalSales : ""} ventas registradas</p>
                                </div>
                                <div className="item">
                                    <h4>Último mes</h4>
                                    <p>
